...
req = requests.get(swig_url[0],headers=headers)
...
mobile_props = soup.find(name="div",attrs={"class":"_3pLy-c"}).text

for props in mobile_props:
    title = soup.find( name="div" , attrs={"class" : "_4rR01T"} ).get_text()
    star_rating = soup.find( name="div" , attrs={"class" : "_3LWZlK"} ).get_text()
    ratings_reviews = soup.find( name="span" , attrs={"class" : "_2_R_DZ"} ).get_text()
    mobile_specs  = soup.find( name="ul" , attrs={"class" : "_1xgFaf"} )
    price = soup.find( name="div" , attrs={"class" : "_25b18c"} ).get_text()
    delivery_date = soup.find( name="div" , attrs={"class" : "_3tcB5a p8ucoS"} ).get_text()
    exchage_off = soup.find( name="div" , attrs={"class" : "_2ZdXDB"} ).get_text()
